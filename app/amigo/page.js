    ...
    return (
      <main>
        <div className="card small-card">
          ...
          <p className="muted"><Link href="/">Volver al inicio</Link></p>\n          {msg && <p className="error">{msg}</p>}
        </div>
      </main>
    );
  }
    ...
    <main>
      <div className="card">
        <div className="header">
          ...
          <div className="actions"><Link href="/" className="button-link secondary">Inicio</Link><button className="secondary" onClick={logout}>Salir</button></div>
        </div>
